...
Every CMU student remembers the stress of their first course registration. There's a lot of information out there, and not a lot of guidance to support you through the process! Our hope is that after reading this article, you leave feeling prepared to secure your ideal schedule, no matter where you are in the registration process.
...
<ExpandableText title="Example (21-241)">
...
<ExpandableText title="Example (76-107)">
...
### Locations
All classroom locations are walkable within 10 minutes of each other except for **Mellon Institute (MI)** and **South Craig Street (3SC and 4SC)**, which are about 15 minutes away from the University Center.

<ExpandableText title="Example (76-101)">
...
- The locations of your classes
  ...
  - Mellon Institute (MI) and South Craig Street (3SC and 4SC) are the only prevalent locations that take about 15 minutes to walk to from the University Center. 10 minutes between classes is usually more than enough for most locations using shortcuts on campus.
...
1. Be added directly to the section, if it doesn't conflict with another course or cause you to exceed your max units
   ...
   <ExpandableText title="Example Email">
   > Dear [STUDENT NAME],
   >
   > You have now been registered from the waitlist for [COURSE NAME AND SECTION] for [SEMESTER].
   >
...
2. Or receive an email invitation to join within 72 hours (24 hours starting the week before the semester begins)
   ...
   > Dear [STUDENT NAME],
   >
   > You are invited to register from the waitlist of [COURSE NAME AND SECTION] for [SEMESTER].
   >
...
<ExpandableText title="Example (15-213)">
