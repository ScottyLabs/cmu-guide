...
To get connected to ODR, you will first need to fill out a disability application form and schedule an appointment with an ODR point person via [their web page for student accommodations](https://www.cmu.edu/disability-resources/students/obtaining-accommodations.html). 
...
Their website can be found [here](https://www.cmu.edu/student-success/), and their services are open to all students. SASC offers feedback for writing assignments, tutoring for specific classes, mentorship to build better academic habits, and more!

### Cares Forms
If you’re concerned about someone else, or if you’re reading this document to know how to support a friend on a mandate, a Cares Form can be submitted [here](https://cm.maxient.com/reportingform.php?CarnegieMellonUniv&layout_id=14) to connect them to more resources if you feel like they’d benefit from that. 

### [CaPS Hotline](https://www.cmu.edu/counseling/get-support/for-yourself.html)
...
*Note: Because CMU provides too many support resources for me to individually name them all, I’ve instead linked [this page](https://www.cmu.edu/student-affairs/resources/index.html) that has a full list of resources you can seek should you need them.*
