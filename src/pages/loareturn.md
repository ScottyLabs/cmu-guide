...
If you’re on a meal plan, I’m also aware that CMU’s dining options leave much to be desired nutrition-wise, so if you want free ingredients to cook healthier meals (or if you are facing food insecurity), consider using the [CMU Pantry](https://www.cmu.edu/student-affairs/resources/cmu-pantry/) located in **Residence on Fifth**. 
