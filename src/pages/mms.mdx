...
(Disclaimer: These sample questions are designed to be representative of the difficulty of the MMS. They are not official, nor should you use them to [study anything beforehand](https://cmu.guide/mms/#how-do-i-prepare-for-the-mms). The MMS is a *placement test* after all!)
...
1. **Problem Solving (Multiple Choice):** This section tests mathematical intuition through short multiple-choice questions in a similar style to those seen on the [American Mathematics Competitions (AMC)](https://artofproblemsolving.com/wiki/index.php/AMC_Problems_and_Solutions). Questions involve algebra, combinatorics, number theory, geometry, probability, logic, and other olympiad-style topics.
   ...
   <ExpandableText title="Example Question">
